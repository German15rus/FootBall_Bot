const TRANSLATIONS = {
  en: {
    ...
    'profile.historyBtn': '📋 Prediction History',
    'profile.activeBtn': '⏳ Current Predictions',
    'profile.noActive': 'No active predictions',
    'profile.activeSub': 'Predictions for upcoming matches',
    'profile.you': 'my',
  ...
  ru: {
    ...
    'profile.historyBtn': '📋 История предиктов',
    'profile.activeBtn': '⏳ Текущие предикты',
    'profile.noActive': 'Нет активных предиктов',
    'profile.activeSub': 'Предикты на предстоящие матчи',
    'profile.you': 'мой',
    'profile.actual': 'факт',
    'shop.btn':         'Магазин',
    'shop.title':       'Магазин',
    ...
    'profile.noFriends':       'Пока нет друзей',
    'friends.requests':        'Заявки в друзья',
    'friends.noRequests':      'Нет новых заявок',
    ...
    'friends.alreadySent':     'Заявка уже отправлена',
  }
};
